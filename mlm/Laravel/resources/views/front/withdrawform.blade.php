...
<center style="border: 1px solid #ced4da!important;border-radius: 10px;padding: 2px;margin: 0px;a">
      <form class="well form-horizontal" action="/withdraw" method="post"  id="contact_form" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <div class="input-group">
          <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
          <input style= "font-size: 17px;font-family:unset;display:flex;margin-bottom: 30px; padding: 0.5rem 0.5rem; height: 50px !important; border: 2px solid #ced4da; justify-content-center"; name="amount" placeholder="Widtdraw Amount USDT" class="form-control"  type="text">
            </div>
